...
def train_one_epoch(sess, ops, train_writer):
    ...
    for fn in range(len(X_train)):
        ...
        for batch_idx in range(num_batches):
            ...
            rotated_data = provider.rotate_point_cloud(X_train[start_idx:end_idx, :, :])
...
def eval_one_epoch(sess, ops, test_writer):
    ...
    for fn in range(len(X_test)):
        log_string('----' + str(fn) + '-----')
        #current_data = current_data[:,0:NUM_POINT,:]
        current_label = np.squeeze(y_test)
        
        file_size = y_train.shape[0]
        num_batches = file_size // BATCH_SIZE
        ...
        for batch_idx in range(num_batches):
            ...
            feed_dict = {ops['pointclouds_pl']: y_train[start_idx:end_idx, :, :],
                         ops['labels_pl']: current_label[start_idx:end_idx],
                         ops['is_training_pl']: is_training}
